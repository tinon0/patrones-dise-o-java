...
public class AbstraccionJuegos extends AbstraccionReproductor{
    public AbstraccionJuegos(PlataformaDispositivo plataforma, ReproductorMultimedia reproductor) {
