...
public class AbstraccionMusica extends AbstraccionReproductor{
    public AbstraccionMusica(PlataformaDispositivo plataforma, ReproductorMultimedia reproductor) {
